...
lcm_env\Scripts\Activate.ps1

# 2. Install dependencies
pip install -r requirements.txt

# 3. Register Jupyter kernel
python -m ipykernel install --user --name=lcm_env --display-name="Python (LCM)"
...
1. In Jupyter Lab, navigate to and open `latent-consistency-models-image-generation.ipynb`
2. Select the **"Python (LCM)"** kernel from the kernel selector in the top-right corner
3. Execute the cells sequentially to:
   - Download the LCM model
   - Convert it to OpenVINO format
